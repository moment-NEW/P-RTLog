...
#include "tokenizer/encode_args.h"
...
static_assert((P_TOKENIZER_CFG_ARG_TYPES_SIZE_BYTES == 4) ||
              ...
              "P_TOKENIZER_CFG_ARG_TYPES_SIZE_BYTES must be 4 or 8");
...
enum class ArgType : uint8_t {
  kInt = P_TOKENIZER_ARG_TYPE_INT,
  kInt64 = P_TOKENIZER_ARG_TYPE_INT64,
  kDouble = P_TOKENIZER_ARG_TYPE_DOUBLE,
  kString = P_TOKENIZER_ARG_TYPE_STRING,
};
