...
// P_TOKENIZER_CFG_C_HASH_LENGTH. The options are:
//
...
#define _P_TOKENIZER_ENTRY_MAGIC 0xBAA98DEE
...
typedef struct {
  uint32_t magic;          // Must be _P_TOKENIZER_ENTRY_MAGIC (0xBAA98DEE).
...
Entry {
 public:
  constexpr Entry(uint32_t token,
      ...
      : header_{.magic = _P_TOKENIZER_ENTRY_MAGIC,
                .token = token,
...
#include "tokenizer/hash.h"

#define P_TOKENIZER_STRING_TOKEN(format) ::pw::tokenizer::Hash(format)

#else  // In C or older C++ code, use the hashing macro.

#if P_TOKENIZER_CFG_C_HASH_LENGTH == 80

#include "tokenizer/internal/pw_tokenizer_65599_fixed_length_80_hash_macro.h"
#define P_TOKENIZER_STRING_TOKEN P_TOKENIZER_65599_FIXED_LENGTH_80_HASH

#elif P_TOKENIZER_CFG_C_HASH_LENGTH == 96

#include "tokenizer/internal/pw_tokenizer_65599_fixed_length_96_hash_macro.h"
#define P_TOKENIZER_STRING_TOKEN P_TOKENIZER_65599_FIXED_LENGTH_96_HASH

#elif P_TOKENIZER_CFG_C_HASH_LENGTH == 128

#include "tokenizer/internal/pw_tokenizer_65599_fixed_length_128_hash_macro.h"
#define P_TOKENIZER_STRING_TOKEN P_TOKENIZER_65599_FIXED_LENGTH_128_HASH

#elif P_TOKENIZER_CFG_C_HASH_LENGTH == 256

#include "tokenizer/internal/pw_tokenizer_65599_fixed_length_256_hash_macro.h"
#define P_TOKENIZER_STRING_TOKEN P_TOKENIZER_65599_FIXED_LENGTH_256_HASH
...
#error "Unsupported value for P_TOKENIZER_CFG_C_HASH_LENGTH"

// Define a placeholder macro to give clearer compilation errors.
#define P_TOKENIZER_STRING_TOKEN(unused) 0u

#endif  // P_TOKENIZER_CFG_C_HASH_LENGTH
